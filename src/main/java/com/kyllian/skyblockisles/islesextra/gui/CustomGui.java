...
import com.kyllian.skyblockisles.islesextra.client.ItemEditor;
...
public class CustomGui extends GenericContainerScreen {
    ...
    // Generic GUI based on chest screens (like servers), probably useless because of the new, custom Textured GUI
